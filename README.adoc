...
=== step variables flow
system works little different with step_vars empty or not


==== no ref to prev event, no ref to prev. step, concurency > 1, step_vars empty
ToDo...

==== no ref to prev event, no ref to prev. step, concurency > 1, step_vars not empty
ToDo...
